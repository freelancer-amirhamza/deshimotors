    ...
    return (
        <section className="mt-2 bg-white">
            <div className="container mx-auto w-full flex justify-center">
                <div className="w-full flex-col gap-1 rounded  md:max-w-4xl  max-w-lg flex p-2 items-center justify-center">
                    ...
                    <div className="w-full max-h-88 flex  justify-center">
                        <img src={image} alt="" className='w-full h-full rounded-md object-fill' />
                    </div>
